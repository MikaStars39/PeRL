...
SAVE_DIR="${SAVE_DIR:-/jpfs-5p/chenyanxu.9/model/Qwen3-8B-dapo-rl_14k-${TIMESTAMP}}"
LOG_DIR=${SAVE_DIR}/output.log
DATA_PATH="/jpfs/chenyanxu.9/data/DAPO-Math-17k-Processed/en/train-00000-of-00001.parquet"
mkdir -p ${SAVE_DIR}
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-8b-dolci-think-rl-dapo-14k
)
